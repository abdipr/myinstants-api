...
if (empty($query)) {
    echo json_encode(["status" => "404", "author" => "abdiputranar", "message" => "Query parameter 'q' is required, example: ?q=id"], JSON_PRETTY_PRINT);
    exit;
}

$url = "https://www.myinstants.com/en/best_of_all_time/" . urlencode($query);
